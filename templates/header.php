...
<head>
    ...
    <meta name="description" content="Visimisi Adalah layanan bot whatsapp gratis">
    <meta name="author" content="Ditzzy">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  sidebar sidebar-success " id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="home.php">
                ...
                <div class="sidebar-brand-text mx-3">VISI-MISI</div>
            </a>
